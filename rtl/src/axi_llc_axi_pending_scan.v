...
//
// This helper centralizes the first-free slot, first-free AXI ID, response ID
// match, and first-complete slot scan over a bridge pending table. The owner
// state remains in axi_llc_axi_bridge; this module only computes combinational
// scan results from packed state snapshots.
