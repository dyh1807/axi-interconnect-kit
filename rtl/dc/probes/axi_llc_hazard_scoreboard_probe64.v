...
// DC-only wrapper for the production dual-port hazard scoreboard at the
// current bridge scale: 64 read entries and 64 write entries.
module axi_llc_hazard_scoreboard_probe64 (
    input         clk,
    input         rst_n,
    ...
    axi_llc_dual_port_hazard_scoreboard #(
        ...
        .READ_HAZARD_COUNT(64),
        .WRITE_HAZARD_COUNT(64)
    ) u_scoreboard (
        .clk(clk),
        .rst_n(rst_n),
