...
// DC-only wrapper for the production MMIO-side single AXI bridge shape used by
// axi_llc_axi_bridge_dual: 4B requests, 32-bit AXI beats, 32 read/write pending
// slots.
module axi_llc_axi_bridge_mmio4_probe (
    input          clk,
    input          rst_n,
    ...
    input  [31:0]  cache_req_wdata,
    input  [3:0]   cache_req_wstrb,
    output         cache_resp_valid,
    input          cache_resp_ready,
    output [31:0]  cache_resp_rdata,
