module axi_llc_axi_bridge_dual_ddr_multibeat_write_formal_top(
    input             clk,
    input             rst_n,
    ...
    input      [63:0] cache_req_wdata_lo,
    input      [63:0] cache_req_wdata_hi,
    input      [15:0] cache_req_wstrb,
    ...
    localparam integer FORMAL_LINE_BYTES = 16;
    localparam integer FORMAL_LINE_BITS = 128;
    localparam integer FORMAL_LINE_OFFSET_BITS = 4;
    ...
    localparam integer FORMAL_READ_RESP_BYTES = 16;
    localparam integer FORMAL_READ_RESP_BITS = 128;
    ...
    axi_llc_axi_bridge_dual #(
        ...
        .cache_req_wdata({cache_req_wdata_hi, cache_req_wdata_lo}),
        ...
        .mmio_axi_arvalid(mmio_axi_arvalid_w),
