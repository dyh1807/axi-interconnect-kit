module cache_ctrl_table_oracle_invalidate_then_read_miss_formal_top(
    input             clk,
    input             rst_n,
    ...
    localparam [FORMAL_ADDR_BITS-1:0] REQ_ADDR = 32'h4000_0100;
    localparam [FORMAL_LINE_BITS-1:0] OLD_LINE = 64'h0102_0304_0506_0708;
    localparam [FORMAL_LINE_BITS-1:0] OTHER_LINE = 64'h1112_1314_1516_1718;
    localparam [FORMAL_LINE_BITS-1:0] REFILL_DATA = 64'h2122_2324_2526_2728;
    localparam [FORMAL_META_BITS-1:0] CLEAN_META = 8'h10;
    localparam [FORMAL_META_BITS-1:0] OTHER_META = 8'h21;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            data_row_r <= {OTHER_LINE, OLD_LINE};
            meta_row_r <= {OTHER_META, CLEAN_META};
            valid_bits_r <= 2'b01;
            repl_way_r <= 1'b0;
        end else begin
            if (data_wr_en) begin
