...
struct module_axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top
{
  bool clk;
  bool rst_n;
...
extern struct
    module_axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top
        axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top;
...
{
  assert(!axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top
              .mmio_axi_arvalid);
  if(arvalid)
  {
    assert(araddr == addr);
...
int main(void)
{
  ...
  axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top.rst_n =
      false;
  drive_idle();
  set_inputs();
  next_timeframe();
  ...
  check_ar_snapshot(
      ...
      axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top
          .ddr_axi_arburst,
      addr);
  if(axi_llc_axi_bridge_dual_prod_width_cacheline_read_response_formal_top
         .ddr_axi_arvalid)
  {
    seen_ar = true;
    arid =
