module axi_llc_axi_bridge_dual_prod_width_mode2_write_formal_top(
    ...
    input      [31:0] bypass_req_wdata,
    input      [3:0]  bypass_req_wstrb,
    ...
    axi_llc_axi_bridge_dual #(
        ...
        .bypass_req_wdata({{(FORMAL_LINE_BITS-32){1'b0}}, bypass_req_wdata}),
        .bypass_req_wstrb({{(FORMAL_LINE_BYTES-4){1'b0}}, bypass_req_wstrb}),
