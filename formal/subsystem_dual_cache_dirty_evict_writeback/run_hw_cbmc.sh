...
build_dir="${repo_root}/local_debug/hw_cbmc_subsystem_dual_cache_dirty_evict_writeback"
timeout_sec="${HW_CBMC_TIMEOUT_SEC:-300}"
harness_c="${HW_CBMC_HARNESS:-${script_dir}/harness.c}"
top_v="${HW_CBMC_TOP_V:-${script_dir}/axi_llc_subsystem_dual_cache_dirty_evict_writeback_formal_top.v}"
top_module="${HW_CBMC_TOP_MODULE:-axi_llc_subsystem_dual_cache_dirty_evict_writeback_formal_top}"
bound="${HW_CBMC_BOUND:-56}"
