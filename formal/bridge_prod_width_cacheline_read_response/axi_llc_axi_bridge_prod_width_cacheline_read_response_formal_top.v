module axi_llc_axi_bridge_prod_width_cacheline_read_response_formal_top(
    input             clk,
    input             rst_n,
    ...
    output            axi_rready,
    input             axi_rid,
    input      [63:0] axi_rdata_0,
    input      [63:0] axi_rdata_1,
    input      [63:0] axi_rdata_2,
    input      [63:0] axi_rdata_3,
    input      [1:0]  axi_rresp,
    input             axi_rlast,
    output            axi_awvalid,
    output            axi_wvalid
    ...
    wire axi_wlast_w;
    wire axi_bready_w;
    wire [FORMAL_DDR_DATA_BITS-1:0] axi_rdata_w;
    ...
    assign axi_rdata_w = {axi_rdata_3, axi_rdata_2, axi_rdata_1, axi_rdata_0};
