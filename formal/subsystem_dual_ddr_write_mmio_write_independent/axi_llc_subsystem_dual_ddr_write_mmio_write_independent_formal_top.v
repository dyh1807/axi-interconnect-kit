module axi_llc_subsystem_dual_ddr_write_mmio_write_independent_formal_top(
    input             clk,
    input             rst_n,
    input             ddr_write_req_valid,
    input             mmio_write_req_valid,
    output            ddr_write_req_ready,
    output            mmio_write_req_ready,
    output            ddr_write_req_accepted,
    ...
    wire [1:0] write_req_ready_w;
    wire [1:0] write_req_accepted_w;
    wire [1:0] write_resp_valid_w;
    wire [2*FORMAL_ID_BITS-1:0] write_resp_id_w;
    wire [3:0] write_resp_code_w;
    ...
    assign mmio_write_req_ready = write_req_ready_w[0];
    assign ddr_write_req_ready = write_req_ready_w[1];
    assign mmio_write_req_accepted = write_req_accepted_w[0];
    assign ddr_write_req_accepted = write_req_accepted_w[1];
    ...
    axi_llc_subsystem_dual #(
        ...
        .write_req_valid({ddr_write_req_valid, mmio_write_req_valid}),
        .write_req_ready(write_req_ready_w),
        .write_req_accepted(write_req_accepted_w),
        .write_req_addr({32'h4000_0008, 32'h1000_0004}),
        .write_req_wdata({32'd0, 32'ha53c_c35a, 32'd0, 32'h5ac3_3ca5}),
        .write_req_wstrb({4'd0, 4'hf, 4'd0, 4'hd}),
        .write_req_total_size({8'd3, 8'd3}),
        .write_req_id({4'h5, 4'h6}),
        .write_req_bypass(2'b11),
        .write_resp_valid(write_resp_valid_w),
        .write_resp_ready(2'b11),
