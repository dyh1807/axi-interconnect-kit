...
`VERIFICATION SUCCESSFUL` 的项目。2026-05-06 当前 stable manifest 为 81 项；
...
`formal/cache_ctrl_table_oracle_partial_write_miss_refill_then_read` 三个 cache-control
...
当前 `formal/*/run_hw_cbmc.sh` 共有 83 个入口，未纳入 stable manifest 的 2 个入口
