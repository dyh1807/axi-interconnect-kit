module cache_ctrl_partial_write_hit_merge_formal_top(
    input             clk,
    input             rst_n,
    input             req_valid,
    output            req_ready,
    ...
    localparam [FORMAL_LINE_BITS-1:0] BASE_LINE = 64'h1122_3344_5566_7788;
    localparam [FORMAL_LINE_BITS-1:0] OTHER_LINE = 64'h0102_0304_0506_0708;
    ...
    assign data_rd_row_w = {OTHER_LINE, BASE_LINE};
    assign meta_rd_row_w = {OTHER_META, CLEAN_META};
    assign data_busy_w = 1'b0;
    assign meta_busy_w = 1'b0;
    assign mem_req_ready_w = 1'b0;
