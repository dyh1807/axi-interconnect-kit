...
struct module_axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
{
  bool clk;
  bool rst_n;
...
extern struct
    module_axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
        axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top;
...
int main(void)
{
  ...
  axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top.rst_n =
      false;
  ...
  for(unsigned step = 0u; step < 24u; step++)
  {
    ...
    assert(!axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
                .ddr_axi_awvalid);
    assert(!axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
                .ddr_axi_wvalid);
    assert(!axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
    ...
    if(axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
           .ddr_read_req_valid &&
       axi_llc_subsystem_dual_ddr_read_mmio_read_independent_formal_top
           .ddr_read_req_ready)
    {
