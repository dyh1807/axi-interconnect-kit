...
struct module_axi_llc_axi_bridge_dual_prod_width_cacheline_write_shape_formal_top
{
  bool clk;
  bool rst_n;
...
extern struct
    module_axi_llc_axi_bridge_dual_prod_width_cacheline_write_shape_formal_top
        axi_llc_axi_bridge_dual_prod_width_cacheline_write_shape_formal_top;
...
int main(void)
{
  ...
  axi_llc_axi_bridge_dual_prod_width_cacheline_write_shape_formal_top.rst_n =
      false;
  drive_idle();
  set_inputs();
  next_timeframe();
  ...
  assert(axi_llc_axi_bridge_dual_prod_width_cacheline_write_shape_formal_top
             .cache_req_ready);
