module axi_llc_axi_bridge_dual_prod_width_cacheline_ar_shape_formal_top(
    input             clk,
    input             rst_n,
    ...
    output            debug_ddr_cache_req_valid,
    output            debug_ddr_cache_req_ready,
    output            debug_ddr_bridge_arvalid,
    output            debug_ddr_bridge_arready,
    output            debug_ddr_ar_hazard,
    output            debug_ddr_ar_slot_hazard,
    output            debug_ddr_ar_pending_write_hazard,
    output            debug_ddr_accept_cache,
    output            debug_ddr_rd_valid_0,
    output            debug_ddr_rd_issue_count_nonzero,
    output            debug_wr_hazard_valid_0,
    output            debug_wr_hazard_valid_1,
    output            debug_ddr_aw_fire,
    output            debug_mmio_aw_fire
);
    ...
    assign debug_ddr_cache_req_valid = dut.ddr_cache_req_valid_w;
    assign debug_ddr_cache_req_ready = dut.ddr_cache_req_ready_w;
    assign debug_ddr_bridge_arvalid = dut.ddr_bridge_arvalid_w;
    assign debug_ddr_bridge_arready = dut.ddr_bridge_arready_w;
    assign debug_ddr_ar_hazard = dut.ddr_ar_hazard_w;
    assign debug_ddr_ar_slot_hazard = dut.ddr_ar_slot_hazard_w;
    assign debug_ddr_ar_pending_write_hazard =
        dut.ddr_ar_pending_write_hazard_w;
    assign debug_ddr_accept_cache = dut.ddr_bridge.accept_cache_w;
    assign debug_ddr_rd_valid_0 = dut.ddr_bridge.rd_valid_r[0];
    assign debug_ddr_rd_issue_count_nonzero =
        (dut.ddr_bridge.rd_issue_count_r != 8'd0);
    assign debug_wr_hazard_valid_0 =
        dut.hazard_scoreboard.wr_hazard_valid_r[0];
    assign debug_wr_hazard_valid_1 =
        dut.hazard_scoreboard.wr_hazard_valid_r[1];
    assign debug_ddr_aw_fire = dut.ddr_aw_fire_w;
    assign debug_mmio_aw_fire = dut.mmio_aw_fire_w;
