module axi_llc_axi_bridge_dual_prod_width_bypass_cacheline_read_response_formal_top(
    input             clk,
    input             rst_n,
    ...
    output     [63:0] bypass_resp_rdata_0,
    output     [63:0] bypass_resp_rdata_1,
    output     [63:0] bypass_resp_rdata_2,
    output     [63:0] bypass_resp_rdata_3,
    output     [63:0] bypass_resp_rdata_4,
    output     [63:0] bypass_resp_rdata_5,
    output     [63:0] bypass_resp_rdata_6,
    output     [63:0] bypass_resp_rdata_7,
    ...
    assign bypass_resp_rdata_0 = bypass_resp_rdata_w[63:0];
    assign bypass_resp_rdata_1 = bypass_resp_rdata_w[127:64];
    assign bypass_resp_rdata_2 = bypass_resp_rdata_w[191:128];
    assign bypass_resp_rdata_3 = bypass_resp_rdata_w[255:192];
    assign bypass_resp_rdata_4 = bypass_resp_rdata_w[319:256];
    assign bypass_resp_rdata_5 = bypass_resp_rdata_w[383:320];
    assign bypass_resp_rdata_6 = bypass_resp_rdata_w[447:384];
    assign bypass_resp_rdata_7 = bypass_resp_rdata_w[511:448];
    assign ddr_axi_rdata_w = {ddr_axi_rdata_3, ddr_axi_rdata_2,
                              ddr_axi_rdata_1, ddr_axi_rdata_0};
    assign ddr_axi_awvalid = ddr_axi_awvalid_w;
    assign ddr_axi_wvalid = ddr_axi_wvalid_w;
