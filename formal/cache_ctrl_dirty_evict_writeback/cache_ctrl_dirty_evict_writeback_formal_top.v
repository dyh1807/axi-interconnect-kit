module cache_ctrl_dirty_evict_writeback_formal_top(
    input             clk,
    input             rst_n,
    input             req_valid,
    output            req_ready,
    ...
    localparam [FORMAL_ADDR_BITS-1:0] VICTIM_ADDR = 32'h4000_0100;
    localparam [FORMAL_ADDR_BITS-1:0] OTHER_ADDR = 32'h4000_0120;
    ...
    assign data_rd_row_w = {OTHER_DATA, VICTIM_DATA};
    assign meta_rd_row_w = {OTHER_META, VICTIM_META};
