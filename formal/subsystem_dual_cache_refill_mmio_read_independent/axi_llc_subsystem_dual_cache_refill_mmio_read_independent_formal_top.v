module axi_llc_subsystem_dual_cache_refill_mmio_read_independent_formal_top(
    input             clk,
    input             rst_n,
    input             ddr_read_req_valid,
    input             mmio_read_req_valid,
    output            ddr_read_req_ready,
    output            mmio_read_req_ready,
    output            ddr_read_req_accepted,
    output            mmio_read_req_accepted,
    output     [3:0]  ddr_read_req_accepted_id,
    output     [3:0]  mmio_read_req_accepted_id,
    ...
    localparam [FORMAL_ADDR_BITS-1:0] MMIO_READ_ADDR = 32'h1000_000c;
    ...
    assign mmio_read_req_ready = read_req_ready_w[0];
    assign ddr_read_req_ready = read_req_ready_w[1];
    assign mmio_read_req_accepted = read_req_accepted_w[0];
    assign ddr_read_req_accepted = read_req_accepted_w[1];
    assign mmio_read_req_accepted_id =
        read_req_accepted_id_w[0 +: FORMAL_ID_BITS];
    ...
    axi_llc_subsystem_dual #(
        ...
        .read_req_valid({ddr_read_req_valid, mmio_read_req_valid}),
        .read_req_ready(read_req_ready_w),
        .read_req_accepted(read_req_accepted_w),
        .read_req_accepted_id(read_req_accepted_id_w),
        .read_req_addr({DDR_READ_ADDR, MMIO_READ_ADDR}),
        .read_req_total_size({8'd7, 8'd3}),
        .read_req_id({4'h6, 4'h9}),
