module axi_llc_axi_bridge_dual_prod_width_same_line_read_blocks_write_formal_top(
    input             clk,
    input             rst_n,
    ...
    localparam [31:0] FORMAL_ADDR = 32'h4000_0300;
    localparam [5:0] FORMAL_READ_ID = 6'h05;
    localparam [5:0] FORMAL_WRITE_ID = 6'h0a;
    ...
    axi_llc_axi_bridge_dual #(
        ...
        .cache_req_addr(FORMAL_ADDR),
        .cache_req_id(cache_req_write ? FORMAL_WRITE_ID : FORMAL_READ_ID),
        .cache_req_size(8'd63),
        .cache_req_wdata({FORMAL_LINE_BITS{1'b1}}),
