module axi_llc_axi_bridge_dual_ddr_multibeat_read_formal_top(
    input             clk,
    input             rst_n,
    ...
    output     [63:0] cache_resp_rdata_lo,
    output     [63:0] cache_resp_rdata_hi,
    ...
    assign cache_resp_rdata_lo = cache_resp_rdata_w[63:0];
    assign cache_resp_rdata_hi = cache_resp_rdata_w[127:64];
