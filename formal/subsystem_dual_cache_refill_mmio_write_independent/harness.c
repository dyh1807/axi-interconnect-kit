...
struct module_axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
{
  bool clk;
  bool rst_n;
...
extern struct
    module_axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
        axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top;
...
int main(void)
{
  ...
  axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top.rst_n =
      false;
  ...
  for(unsigned step = 0u; step < 36u; step++)
  {
    ...
    axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
        .mmio_write_req_valid = seen_ddr_ar && !mmio_request_seen;
    axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
        .ddr_axi_arready = false;
    axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
        .mmio_axi_awready = false;
    ...
    assert(!axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                .ddr_axi_awvalid);
    assert(!axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                .ddr_axi_wvalid);
    assert(!axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
    ...
    if(axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
           .ddr_read_req_valid &&
       axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
           .ddr_read_req_ready)
    {
           ...
           .mmio_axi_wvalid)
    {
      ...
      assert(axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                 .ddr_axi_arvalid);
      assert(axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                 .mmio_axi_wdata == 0xdeadbeefu);
      assert(axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                 .mmio_axi_wstrb == 0x0fu);
      assert(axi_llc_subsystem_dual_cache_refill_mmio_write_independent_formal_top
                 .mmio_axi_wlast);
    }
