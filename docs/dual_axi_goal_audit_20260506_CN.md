...
审计时间：2026-05-06 20:26 CST，主机 `eda-10`。
...
| RTL contract suite | 全量 contract 通过 | 已通过 53/53；compat read-response shared payload pool 和 pool-index signedness cleanup 后已复跑 | `rtl/local_debug/vcs_all_contracts_resp_pool_idx_cleanup_20260506_202344_eda10/driver.log` |
