...
审计时间：2026-05-06 19:55 CST，主机 `eda-10`。
...
| RTL contract suite | 全量 contract 通过 | 已通过 53/53；compat/bridge invalid-payload no-clear RTL hygiene 后均已复跑 | `local_debug/vcs_all_contracts_bridge_payload_no_clear_20260506_195341_eda10/driver.log` |
...
- 2026-05-06 19:55 CST 已停止该旧 sanity；下一条 current-HEAD sanity 应基于
  compat+bridge 两处 hygiene 后的 RTL 启动

## 下一步

1. 基于当前 HEAD 启动新的 `axi_llc_subsystem_compat` link sanity，覆盖 compat+bridge
